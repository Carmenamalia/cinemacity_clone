                        ...
                        .addSecuritySchemes(securitySchemeName, new SecurityScheme()
                                ...
                                .flows(new OAuthFlows()
                                        .authorizationCode(new OAuthFlow()
                                                .authorizationUrl("http://localhost:8070/auth/realms/master/protocol/openid-connect/auth")
                                                .tokenUrl("http://localhost:8070/auth/realms/master/protocol/openid-connect/token")
